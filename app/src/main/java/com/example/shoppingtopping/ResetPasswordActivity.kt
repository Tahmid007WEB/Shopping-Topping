...
import com.example.shoppingtopping.databinding.ActivityResetPasswordBinding
...
class ResetPasswordActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.btnResetPw.setOnClickListener{
            ...
            Toast.makeText(this, "A link sent to your email" , Toast.LENGTH_SHORT ).show()
                ...
                .addOnCompleteListener(this){reset->
                    if(reset.isSuccessful){
                        Intent(this,LoginActivity::class.java).also {
                            ...
                            startActivity(it)
                            Toast.makeText(this, "Invalid email to reset password" , Toast.LENGTH_SHORT ).show()
                        }
                    }else {
